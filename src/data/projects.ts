    ...
    caseStudy: {
      ...
      shots: [
        ...
        },
        {
          ...
          lead: "Articles & success stories the team ships in any language",
          body: " — Spanish, English and Portuguese from one CMS, no developer in the loop.",
    ...
    caseStudy: {
      ...
      shots: [
        ...
        },
        {
          n: "02",
          label: "02 — The method",
          lead: "“Una escuela de inglés distinta”, in motion",
          body: " — the bike metaphor carried through illustration and scroll-tied reveals.",
          placeholder: "Method — drop screenshot",
          image: "/assets/bike-shot2.webp",
        },
        {
          n: "03",
          label: "03 — Our story",
          lead: "Community and brand, scroll-paced",
          body: " — “Nuestra historia” turns the about page into part of the ride.",
          placeholder: "Story — drop screenshot",
