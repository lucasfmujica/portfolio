...
export const projects: Project[] = [
  {
    ...
    caseStudy: {
      ...
      year: "2026",
      liveUrl: "https://fullydialed.ca/",
      liveLabel: "fullydialed.ca",
      outcome: {
        pre: "A mobile ADAS calibration brand that helps repair shops keep every vehicle ",
        ember: "fully dialed.",
      },
      tags: ["Webflow", "Responsive", "SEO", "Conversion"],
      heroImage: "/assets/fullydialed-hero.webp",
      heroImageAlt: "Fully Dialed ADAS calibration and glass services homepage",
      heroBadge: "fullydialed.ca · home",
      highlights: [
        "A clear path from a repair shop's problem to a qualified *get-in-touch conversation*.",
        "ADAS calibration and glass services explained in plain language for busy shops.",
        "A mobile-first marketing site built around trust, safety and faster turnarounds.",
      ],
      services: ["Web Design", "Webflow Development", "Responsive Build", "SEO"],
      challengeHeading: "Safety-critical services needed a site people could understand quickly.",
      challengeBody:
        "Fully Dialed brings mobile ADAS calibration and glass services directly to repair shops. The site needed to explain a technical, safety-critical service without overwhelming the visitor, make the mobile model obvious, and turn confidence into a call or form submission. The answer was a focused structure built around *clarity, proof and a short path to contact*.",
      challengeVisualCaption: "fullydialed.ca · home",
      specs: [
        { key: "role", value: "Webflow design and development" },
        { key: "stack", value: "Webflow · HTML · CSS · JavaScript" },
        { key: "integration", value: "Responsive contact form · SEO" },
      ],
      buildHeading: "A direct route from uncertainty to a scheduled calibration.",
      buildLead:
        "I built a mobile-first marketing experience that puts the safety problem first, then makes the solution tangible: mobile calibration vehicles, OEM-specified procedures, certified technicians and insurer-friendly reporting. The page uses *short sections, repeated contact points and a three-step process* so a shop owner can understand the service and act without digging.",
      shotAspect: "16 / 9",
      shots: [
        {
          n: "01",
          label: "01 / Hero",
          lead: "The safety message lands immediately",
          body: ". A strong visual and plain-language headline explain why calibration matters after repairs or glass replacement.",
        ...
        },
        {
          n: "02",
          label: "02 / Services",
          lead: "Calibration and glass, clearly connected",
          body: ". The service story explains the relationship between windshield replacement, cameras and recalibration.",
          placeholder: "Services: drop screenshot",
        },
        {
          n: "03",
          label: "03 / Process",
          lead: "Identify, calibrate, document and deliver",
          body: ". A three-step process gives repair shops a simple picture of what happens next.",
          placeholder: "Process: drop screenshot",
        },
      ],
      resultsStatement: "A focused site for a service where clarity protects the customer.",
      resultsSub:
        "Launched on Webflow with a responsive structure the Fully Dialed team can keep current as services and calibration centres grow.",
      metrics: [
...
export const projectsCopyEs: Record<string, ProjectCopy> = {
  "fully-dialed": {
    ...
    caseStudy: {
      outcome: { pre: "Una marca de calibración ADAS móvil que ayuda a los talleres a dejar cada vehículo ", ember: "fully dialed." },
      highlights: [
        "Un camino claro desde el problema del taller hasta una *conversación de contacto calificada*.",
        "Calibración ADAS y servicios de cristales explicados en lenguaje simple.",
        "Un sitio mobile-first centrado en confianza, seguridad y tiempos de entrega más rápidos.",
      ],
      services: ["Diseño web", "Desarrollo en Webflow", "Responsive", "SEO"],
      challengeHeading: "Servicios críticos para la seguridad necesitaban un sitio fácil de entender.",
      challengeBody: "Fully Dialed lleva calibración ADAS y servicios de cristales a los talleres. El sitio tenía que explicar un servicio técnico sin abrumar, hacer visible el modelo móvil y convertir confianza en una llamada o formulario. La respuesta fue una estructura enfocada en *claridad, prueba y un camino corto al contacto*.",
      buildHeading: "Un camino directo desde la duda hasta una calibración agendada.",
      buildLead: "Construí una experiencia de marketing mobile-first que presenta primero el problema de seguridad y después vuelve concreta la solución: vehículos móviles, procedimientos OEM, técnicos certificados y reportes compatibles con aseguradoras. *Secciones breves, puntos de contacto repetidos y un proceso de tres pasos* mantienen la acción cerca.",
      resultsStatement: "Un sitio enfocado para un servicio donde la claridad protege al cliente.",
      resultsSub: "Lanzado en Webflow con una estructura responsive que el equipo puede mantener mientras crecen sus servicios y centros de calibración.",
      shots: [
        { label: "01 / Hero", lead: "El mensaje de seguridad llega de inmediato", body: ". Una imagen fuerte y un titular simple explican por qué calibrar importa.", placeholder: "Hero: agregar captura" },
        { label: "02 / Servicios", lead: "Calibración y cristales, conectados con claridad", body: ". La historia explica la relación entre cambiar el parabrisas, las cámaras y la recalibración.", placeholder: "Servicios: agregar captura" },
        { label: "03 / Proceso", lead: "Identificar, calibrar, documentar y entregar", body: ". Un proceso de tres pasos muestra qué sucede después.", placeholder: "Proceso: agregar captura" },
      ],
    },
  },
  "true-north-jerseys": {
